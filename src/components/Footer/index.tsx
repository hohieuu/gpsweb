        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 flex items-center gap-2">
                  <AIGPSIcon className="text-primary shrink-0" size={32} />
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              ...
              Copyright © 2025 AIGPS – aigps.vn. <span className="font-semibold text-primary">Lắp đặt định vị</span> tại Huế.
            </p>
          </div>
        </div>
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#C20F0F" stopOpacity="0.62" />
              ...
              >
                ...
                <stop offset="1" stopColor="#C20F0F" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
