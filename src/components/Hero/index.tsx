...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-white pb-20 pt-[100px] dark:bg-gray-dark md:pb-24 md:pt-[130px] xl:pb-28 xl:pt-[160px] 2xl:pb-32 2xl:pt-[180px]"
      >
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[920px] text-center">
                ...
                <div className="mb-6 flex flex-wrap justify-center gap-4">
                  <a
                    href={`tel:${PHONE}`}
                    className="inline-flex items-center rounded-sm bg-primary px-8 py-4 text-base font-semibold text-white shadow-submit duration-300 hover:bg-primary/90 dark:shadow-submit-dark"
                  >
                    Gọi ngay {PHONE}
                  </a>
                  <a
        ...
        <div className="absolute right-0 top-0 z-[-1] opacity-30 lg:opacity-100">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop offset="0.145833" stopColor="#C20F0F" stopOpacity="0" />
                <stop offset="1" stopColor="#C20F0F" stopOpacity="0.08" />
              </radialGradient>
              <radialGradient
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#C20F0F" stopOpacity="0" />
